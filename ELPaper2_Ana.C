...
//the same concept as merge ana but with some more analyses done for the thesis. 
...
void ELPaper2_Ana(){
  ...
  std::vector<double> abs_gain_p2_0b_primnorm;
  std::vector<double> abs_gain_p2_0b_EL;
  std::vector<double> pen_mesh_p2_0b = { 0, 100,150, 200, 300, 400,500,600, 900};
  std::vector<double> E_N_mesh_p2_0b;  
  
  std::vector<double> abs_gain_p2_0;
  std::vector<double> abs_gain_p2_0_primnorm;
  std::vector<double> abs_gain_p2_0_EL;
  ...
  std::vector<double> abs_gain_p1_5_primnorm;
  std::vector<double> abs_gain_p1_5_EL;
  ...
  int p2_0b_ds = pen_mesh_p2_0b.size(); // number of data sets taken at p1_2
  ...
  path_store.push_back({});
  path_store.back().push_back("/home/amarinei/Year1_PhD/TPC/Comissioning/TPC_Ana/LeCroyPMT_Ana/Swan_TTrees/Configuration_P25/C4600_LSF2550_ThGUp2250_ThGDnGND_PMesh0_TPC1650_p2_0_ii/");
  evt_num.push_back("4600");

  path_store.push_back({});
  path_store.back().push_back("/home/amarinei/Year1_PhD/TPC/Comissioning/TPC_Ana/LeCroyPMT_Ana/Swan_TTrees/Configuration_P25/C4600_LSF2550_ThGUp2250_ThGDnGND_PMesh050_TPC1650_p2_0/");
  evt_num.push_back("5000");  

  path_store.push_back({});
  path_store.back().push_back("/home/amarinei/Year1_PhD/TPC/Comissioning/TPC_Ana/LeCroyPMT_Ana/Swan_TTrees/Configuration_P25/C4600_LSF2550_ThGUp2250_ThGDnGND_PMesh200_TPC1650_p2_0/");
  evt_num.push_back("5000");


  path_store.push_back({});
  path_store.back().push_back("/home/amarinei/Year1_PhD/TPC/Comissioning/TPC_Ana/LeCroyPMT_Ana/Swan_TTrees/Configuration_P25/C4600_LSF2550_ThGUp2250_ThGDnGND_PMesh400_TPC1650_p2_0/");
  evt_num.push_back("5000");
 
  path_store.push_back({});
  path_store.back().push_back("/home/amarinei/Year1_PhD/TPC/Comissioning/TPC_Ana/LeCroyPMT_Ana/Swan_TTrees/Configuration_P25/C4600_LSF2550_ThGUp2250_ThGDnGND_PMesh500_TPC1650_p2_0/");
  evt_num.push_back("5000");

  path_store.push_back({});
  path_store.back().push_back("/home/amarinei/Year1_PhD/TPC/Comissioning/TPC_Ana/LeCroyPMT_Ana/Swan_TTrees/Configuration_P25/C4600_LSF2550_ThGUp2250_ThGDnGND_PMesh640_TPC1650_p2_0/");
  evt_num.push_back("5000");

  path_store.push_back({});
  path_store.back().push_back("/home/amarinei/Year1_PhD/TPC/Comissioning/TPC_Ana/LeCroyPMT_Ana/Swan_TTrees/Configuration_P25/C4600_LSF2550_ThGUp2250_ThGDnGND_PMesh850_TPC1650_p2_0/");
  evt_num.push_back("5000");
  ...
  cout << " p2_0b " << p2_0b_ds << endl;
  cout << " p2_0 " << p2_0_ds << endl;
  cout << " p1_5 " << p1_5_ds << endl;

  cout <<  -1 + p1_0_ds + p2_0b_ds  + 1 << " asdasda " <<  -1 + p1_0_ds + p2_0b_ds  + p2_0_ds << endl;
  ...
  std::vector<double> mean;
    ...
    std::vector<double> err_abs_1bar;
    std::vector<double> err_abs_1_5bar;
    std::vector<double> err_abs_2bar;
    std::vector<double> err_abs_2bar_b;
 
    std::vector<double> err_abs_1bar_primnorm;
    std::vector<double> err_abs_1_5bar_primnorm;
    std::vector<double> err_abs_2bar_primnorm;
    std::vector<double> err_abs_2bar_b_primnorm;
    ...
    for (int i(0); i < file_store.size(); i++){
      ...
      if(i < pen_mesh_p1_0.size()) {
	err_abs_1bar.push_back(err_IntgWFSum_a[i]);
	err_abs_1bar_primnorm.push_back(err_IntgWFSum_a[i]/2);
      }else if(pen_mesh_p1_0.size() <= i && i < pen_mesh_p1_0.size()+pen_mesh_p2_0b.size()){
	err_abs_2bar_b.push_back(err_IntgWFSum_a[i]);
	err_abs_2bar_b_primnorm.push_back(err_IntgWFSum_a[i]/2);
      } else if ( pen_mesh_p1_0.size()+ pen_mesh_p2_0b.size() <= i && i < pen_mesh_p1_0.size()+pen_mesh_p2_0b.size()+pen_mesh_p2_0.size()){
	err_abs_2bar.push_back(err_IntgWFSum_a[i]);
	err_abs_2bar_primnorm.push_back(err_IntgWFSum_a[i]/2);
      } else if (i >= pen_mesh_p1_0.size()+pen_mesh_p2_0b.size()+pen_mesh_p2_0.size()){
	err_abs_1_5bar.push_back(err_IntgWFSum_a[i]);
	err_abs_1_5bar_primnorm.push_back(err_IntgWFSum_a[i]/1.5);
      }
  ...
  double ThGEM_Pht_p1_0(0), ThGEM_Pht_p1_5(0), ThGEM_Pht_p2_0(0), ThGEM_Pht_p2_0b(0);  
  double ct_p1_0(0),ct_p1_5(0),ct_p2_0(0),ct_p2_0b(0);
  double ELThr= 4;

  for (int i(0); i < p1_0_ds; i++){
    abs_gain_p1_0.push_back(SumOfWFSum_a.at(i)); 
    abs_gain_p1_0_primnorm.push_back(SumOfWFSum_a.at(i)); 
    E_N_mesh_p1_0.push_back(GetE_N(pen_mesh_p1_0.at(i), 0.26, 1e5));
    
    if (E_N_mesh_p1_0.back() < ELThr){
      ThGEM_Pht_p1_0 += abs_gain_p1_0.back();
      ct_p1_0++;
    }
  ...
  for (int i = 0; i < p2_0b_ds; i++){
    abs_gain_p2_0b.push_back(SumOfWFSum_a.at(i + p1_0_ds)); 
    abs_gain_p2_0b_primnorm.push_back(SumOfWFSum_a.at(i + p1_0_ds)/2); 
    E_N_mesh_p2_0b.push_back(GetE_N(pen_mesh_p2_0b.at(i), 0.26, 2.0e5));
    cout << " at file " << i + p1_0_ds << " the number of signal: " << HowManySignalEvt[i + p1_0_ds] << ", mesh voltage " << pen_mesh_p2_0b.at(i)  << " , red voltage: " << E_N_mesh_p2_0b[i] << endl; 
    
    if (E_N_mesh_p2_0b.back() < ELThr){
      ThGEM_Pht_p2_0b += abs_gain_p2_0b.back();
      ct_p2_0b++;
    }
  }
  ...
  for (int i = 0; i < p2_0_ds; i++){
    abs_gain_p2_0.push_back(SumOfWFSum_a.at(i +p1_0_ds+ p2_0b_ds));
    abs_gain_p2_0_primnorm.push_back(SumOfWFSum_a.at(i +p1_0_ds+ p2_0b_ds)/2);
    E_N_mesh_p2_0.push_back(GetE_N(pen_mesh_p2_0.at(i), 0.26, 2e5));
    cout << " at file " << i + p1_0_ds +p2_0b_ds << " the number of signal: " << HowManySignalEvt[i + p1_0_ds + p2_0b_ds] << ", mesh voltage " << pen_mesh_p2_0.at(i)  << " , red voltage: " << E_N_mesh_p2_0[i] << endl;   
    if (E_N_mesh_p2_0.back() < ELThr){
      ThGEM_Pht_p2_0 += abs_gain_p2_0.back();
      ct_p2_0++;
    }
  }
  ...
  for (int i = 0; i < p1_5_ds; i++){
    abs_gain_p1_5.push_back(SumOfWFSum_a.at(i +p1_0_ds+ p2_0b_ds + p2_0_ds));
    abs_gain_p1_5_primnorm.push_back(SumOfWFSum_a.at(i +p1_0_ds+ p2_0b_ds + p2_0_ds)/1.5);
    E_N_mesh_p1_5.push_back(GetE_N(pen_mesh_p1_5.at(i), 0.26, 1.5e5));
    
    if (E_N_mesh_p1_5.back() < ELThr){
      ThGEM_Pht_p1_5 += abs_gain_p1_5.back();
      ct_p1_5++;
    }  
  }
  ...
  // calculating the number of photons detected by the ThGEM only: 
  ThGEM_Pht_p1_0 /= ct_p1_0; 
  ThGEM_Pht_p1_5 /= ct_p1_5; 
  ThGEM_Pht_p2_0 /= ct_p2_0; 
  ThGEM_Pht_p2_0b /= ct_p2_0b; 
  
  cout << " The number of photons originating from the ThGEM only is: "<< endl << "1 bar: " << ThGEM_Pht_p1_0 << " pm " << err_abs_1bar.at(0)<< ", 1.5 bar = " << ThGEM_Pht_p1_5 << " pm " << err_abs_1_5bar.at(0)<< ", 2 bar (ThGEM2250):  " << ThGEM_Pht_p2_0 << " pm " << err_abs_2bar.at(0)<< ", 2 bar (ThGEM2250):" << ThGEM_Pht_p2_0b << " pm " << err_abs_2bar_b.at(0)<< endl; 

  //Doing the baseline shift to get the ThGEM contribution only. 
  for (int i(0); i < abs_gain_p1_0.size(); i++){
    abs_gain_p1_0_EL.push_back(abs_gain_p1_0.at(i)-ThGEM_Pht_p1_0);
  }
  for (int i(0); i < abs_gain_p1_5.size(); i++){
    abs_gain_p1_5_EL.push_back(abs_gain_p1_5.at(i)-ThGEM_Pht_p1_5);
  }
  for (int i(0); i < abs_gain_p2_0.size(); i++){
    abs_gain_p2_0_EL.push_back(abs_gain_p2_0.at(i)-ThGEM_Pht_p2_0);
  }
  for (int i(0); i < abs_gain_p2_0b.size(); i++){
    abs_gain_p2_0b_EL.push_back(abs_gain_p2_0b.at(i)-ThGEM_Pht_p2_0b);
  }
  ...
  std::vector<double> zeros_1bar(err_abs_1bar.size(), 0);
  std::vector<double> zeros_2bar(err_abs_2bar.size(), 0);
  std::vector<double> zeros_2bar_b(err_abs_2bar_b.size(), 0);
  std::vector<double> zeros_1_5bar(err_abs_1_5bar.size(), 0);

  std::vector<double> zeros_1bar_primnorm(err_abs_1bar_primnorm.size(), 0);
  std::vector<double> zeros_2bar_primnorm(err_abs_2bar_primnorm.size(), 0);
  std::vector<double> zeros_2bar_b_primnorm(err_abs_2bar_b_primnorm.size(), 0);
  std::vector<double> zeros_1_5bar_primnorm(err_abs_1_5bar_primnorm.size(), 0);  
  //output data for python

  cout << " " << endl;

  cout << "pen_mesh_p1_0 = [";
  VecForPyth(pen_mesh_p1_0);

  cout << "abs_gain_p1_0 = [";
  VecForPyth(abs_gain_p1_0);

  cout <<  "err_abs_1bar =[";
  VecForPyth(err_abs_1bar);

  cout <<  "E_N_mesh_p1_0 = [";
  VecForPyth(E_N_mesh_p1_0);
  
  cout << " " << endl;
  cout << "pen_mesh_p1_5 = [";
  VecForPyth(pen_mesh_p1_5);
  cout << "abs_gain_p1_5 = [";
  VecForPyth(abs_gain_p1_5);
  cout <<  "err_abs_1_5bar =[";
  VecForPyth(err_abs_1_5bar);
  cout <<  "E_N_mesh_p1_5 = [";
  VecForPyth(E_N_mesh_p1_5);
  
  cout << " " << endl;
  cout << "pen_mesh_p2_0b = [";
  VecForPyth(pen_mesh_p2_0b);
  cout <<  "E_N_mesh_p2_0b = [";
  VecForPyth(E_N_mesh_p2_0b);
  cout << "abs_gain_p2_0b = [";
  VecForPyth(abs_gain_p2_0b);
  cout <<  "err_abs_2barb =[";
  VecForPyth(err_abs_2bar_b);

  cout << " " << endl;
  cout << "pen_mesh_p2_0 = [";
  VecForPyth(pen_mesh_p2_0);
  cout <<  "E_N_mesh_p2_0 = [";
  VecForPyth(E_N_mesh_p2_0);
  cout << "abs_gain_p2_0 = [";
  VecForPyth(abs_gain_p2_0);
  cout <<  "err_abs_2bar =[";
  VecForPyth(err_abs_2bar);
    

  TGraphErrors *gr_p1_0 = new TGraphErrors(abs_gain_p1_0.size(), &E_N_mesh_p1_0[0], &abs_gain_p1_0[0],  &zeros_1bar[0],  &err_abs_1bar[0]);
  TGraphErrors *gr_p2_0b = new TGraphErrors(abs_gain_p2_0b.size(), &E_N_mesh_p2_0b[0], &abs_gain_p2_0b[0],&zeros_2bar_b[0], &err_abs_2bar_b[0]);
  TGraphErrors *gr_p2_0 = new TGraphErrors(abs_gain_p2_0.size(), &E_N_mesh_p2_0[0], &abs_gain_p2_0[0],&zeros_2bar[0],  &err_abs_2bar[0]);
  TGraphErrors *gr_p1_5 = new TGraphErrors(abs_gain_p1_5.size(), &E_N_mesh_p1_5[0], &abs_gain_p1_5[0],&zeros_1_5bar[0],  &err_abs_1_5bar[0]);

  TGraphErrors *gr_p1_0_EL = new TGraphErrors(abs_gain_p1_0_EL.size(), &E_N_mesh_p1_0[0], &abs_gain_p1_0_EL[0],  &zeros_1bar[0],  &err_abs_1bar[0]);
  TGraphErrors *gr_p2_0b_EL = new TGraphErrors(abs_gain_p2_0b_EL.size(), &E_N_mesh_p2_0b[0], &abs_gain_p2_0b_EL[0],&zeros_2bar_b[0], &err_abs_2bar_b[0]);
  TGraphErrors *gr_p2_0_EL = new TGraphErrors(abs_gain_p2_0_EL.size(), &E_N_mesh_p2_0[0], &abs_gain_p2_0_EL[0],&zeros_2bar[0],  &err_abs_2bar[0]);
  TGraphErrors *gr_p1_5_EL = new TGraphErrors(abs_gain_p1_5_EL.size(), &E_N_mesh_p1_5[0], &abs_gain_p1_5_EL[0],&zeros_1_5bar[0],  &err_abs_1_5bar[0]);

  TGraphErrors *gr_p1_0_primnorm = new TGraphErrors(abs_gain_p1_0_primnorm.size(), &E_N_mesh_p1_0[0], &abs_gain_p1_0_primnorm[0],  &zeros_1bar_primnorm[0],  &err_abs_1bar_primnorm[0]);
  TGraphErrors *gr_p2_0b_primnorm = new TGraphErrors(abs_gain_p2_0b_primnorm.size(), &E_N_mesh_p2_0b[0], &abs_gain_p2_0b_primnorm[0],&zeros_2bar_b_primnorm[0], &err_abs_2bar_b_primnorm[0]);
  TGraphErrors *gr_p2_0_primnorm = new TGraphErrors(abs_gain_p2_0_primnorm.size(), &E_N_mesh_p2_0[0], &abs_gain_p2_0_primnorm[0],&zeros_2bar_primnorm[0],  &err_abs_2bar_primnorm[0]);
  TGraphErrors *gr_p1_5_primnorm = new TGraphErrors(abs_gain_p1_5_primnorm.size(), &E_N_mesh_p1_5[0], &abs_gain_p1_5_primnorm[0],&zeros_1_5bar_primnorm[0],  &err_abs_1_5bar_primnorm[0]);



  TGraphErrors *gr_p1_0_V = new TGraphErrors(abs_gain_p1_0.size(), &pen_mesh_p1_0[0], &abs_gain_p1_0[0],  &zeros_1bar[0],  &err_abs_1bar[0]);
  //TGraph *gr_p2_0b = new TGraph(abs_gain_p2_0b.size(), &E_N_mesh_p2_0b[0], &abs_gain_p2_0b[0]);
  TGraphErrors *gr_p2_0_V = new TGraphErrors(abs_gain_p2_0.size(), &pen_mesh_p2_0[0], &abs_gain_p2_0[0],&zeros_2bar[0],  &err_abs_2bar[0]);
  TGraphErrors *gr_p1_5_V = new TGraphErrors(abs_gain_p1_5.size(), &pen_mesh_p1_5[0], &abs_gain_p1_5[0],&zeros_1_5bar[0],  &err_abs_1_5bar[0]);
   

  

  gr_p1_0 ->GetYaxis()->SetTitleOffset(0.6);
  gr_p1_0 ->SetLineColor(kMagenta-2);
  gr_p1_0 ->SetLineWidth(2);
  gr_p1_0 ->SetMarkerStyle(20);


  gr_p2_0 ->GetYaxis()->SetTitleOffset(0.6);
  gr_p2_0 ->SetLineColor(1000);
  gr_p2_0 ->SetLineWidth(2);
  gr_p2_0 ->SetFillColor(kBlue);
  gr_p2_0 ->SetMarkerStyle(20);


  gr_p2_0b ->GetYaxis()->SetTitleOffset(0.6);
  gr_p2_0b ->SetLineColor(kOrange-3);
  gr_p2_0b ->SetLineWidth(2);
  gr_p2_0b ->SetFillColor(kBlue);
  gr_p2_0b ->SetMarkerStyle(20);


  gr_p1_5 ->GetYaxis()->SetTitleOffset(0.6);
  gr_p1_5 ->SetLineColor(kTeal-7);
  gr_p1_5 ->SetLineWidth(2);
  gr_p1_5 ->SetFillColor(kBlack);
  gr_p1_5 ->SetMarkerStyle(20);


  gr_p1_0_EL ->GetYaxis()->SetTitleOffset(0.6);
  gr_p1_0_EL ->SetLineColor(kMagenta-2);
  gr_p1_0_EL ->SetLineWidth(1);
  gr_p1_0_EL ->SetMarkerStyle(20);
  gr_p1_0_EL->SetTitle(";EL gap E/N (Td); EL photon number per event" );

  gr_p2_0_EL ->GetYaxis()->SetTitleOffset(0.6);
  gr_p2_0_EL ->SetLineColor(1000);
  gr_p2_0_EL ->SetLineWidth(1);
  gr_p2_0_EL ->SetFillColor(kBlue);
  gr_p2_0_EL ->SetMarkerStyle(20);
  gr_p2_0_EL->SetTitle(";EL gap E/N (Td); EL photon number per event" );


  gr_p2_0b_EL ->GetYaxis()->SetTitleOffset(0.6);
  gr_p2_0b_EL ->SetLineColor(kOrange-3);
  gr_p2_0b_EL ->SetLineWidth(1);
  gr_p2_0b_EL ->SetFillColor(kBlue);
  gr_p2_0b_EL ->SetMarkerStyle(20);
  gr_p2_0b_EL->SetTitle(";EL gap E/N (Td); EL photon number per event" );

  gr_p1_5_EL ->GetYaxis()->SetTitleOffset(0.6);
  gr_p1_5_EL ->SetLineColor(kTeal-7);
  gr_p1_5_EL->SetLineWidth(1);
  gr_p1_5_EL ->SetFillColor(kBlack);
  gr_p1_5_EL ->SetMarkerStyle(20);
  gr_p1_5_EL->SetTitle(";EL gap E/N (Td); EL photon number per event" );

  
  gr_p1_0_primnorm ->GetYaxis()->SetTitleOffset(0.6);
  gr_p1_0_primnorm ->SetLineColor(kMagenta-2);
  gr_p1_0_primnorm ->SetLineWidth(2);
  //gr_p1_0 ->SetFillColor(kBlack);
  gr_p1_0_primnorm ->SetMarkerStyle(20);


  gr_p2_0_primnorm ->GetYaxis()->SetTitleOffset(0.6);
  gr_p2_0_primnorm ->SetLineColor(1000);
  gr_p2_0_primnorm ->SetLineWidth(2);
  gr_p2_0_primnorm ->SetFillColor(kBlue);
  gr_p2_0_primnorm ->SetMarkerStyle(20);


  gr_p2_0b_primnorm ->GetYaxis()->SetTitleOffset(0.6);
  gr_p2_0b_primnorm ->SetLineColor(kOrange -3);
  gr_p2_0b_primnorm ->SetLineWidth(2);
  gr_p2_0b_primnorm ->SetFillColor(kBlue);
  gr_p2_0b_primnorm ->SetMarkerStyle(20);


  gr_p1_5_primnorm ->GetYaxis()->SetTitleOffset(0.6);
  gr_p1_5_primnorm ->SetLineColor(kTeal-7);
  gr_p1_5_primnorm ->SetLineWidth(2);
  gr_p1_5_primnorm ->SetFillColor(kBlack);
  gr_p1_5_primnorm ->SetMarkerStyle(20);



  gr_p1_0_V ->GetYaxis()->SetTitleOffset(0.6);
  gr_p1_0_V ->SetLineColor(kMagenta-2);
  gr_p1_0_V ->SetLineWidth(2);
  //gr_p1_0 ->SetFillColor(kBlack);
  gr_p1_0_V ->SetMarkerStyle(20);


  gr_p2_0_V ->GetYaxis()->SetTitleOffset(0.6);
  gr_p2_0_V ->SetLineColor(1000);
  gr_p2_0_V ->SetLineWidth(2);
  gr_p2_0_V ->SetFillColor(kBlue);
  gr_p2_0_V ->SetMarkerStyle(20);

  gr_p1_5_V ->GetYaxis()->SetTitleOffset(0.6);
  gr_p1_5_V ->SetLineColor(kTeal-7);
  gr_p1_5_V ->SetLineWidth(2);
  gr_p1_5_V ->SetFillColor(kBlack);
  gr_p1_5_V ->SetMarkerStyle(20);
  ...
  //leg->AddEntry(gr_p2_0, " 2 bar - ThGEM 2250", "l");
  leg->AddEntry(gr_p1_0, " 1 bar", "l");
  leg->AddEntry(gr_p1_5, " 1.5 bar", "l");
  leg->AddEntry(gr_p2_0b, " 2 bar", "l");  
  leg->Draw();
  ...
  auto leg_primnorm = new TLegend(0.1,0.7,0.48,0.9);
  leg_primnorm->AddEntry(gr_p2_0, " 2 bar - ThGEM 2250 V", "l");
  leg_primnorm->AddEntry(gr_p2_0b, " 2 bar - ThGEM 2150 V", "l");  
  leg_primnorm->AddEntry(gr_p1_0, " 1 bar", "l");
  leg_primnorm->AddEntry(gr_p1_5, " 1.5 bar", "l");

 
  TMultiGraph *mgr_primnorm = new TMultiGraph();
  mgr_primnorm->SetTitle("; EL gap E/N (Td); Normalised number of photons ");
  mgr_primnorm-> Add(gr_p1_0_primnorm, "ALP");
  mgr_primnorm-> Add(gr_p2_0b_primnorm, "ALP");
  mgr_primnorm-> Add(gr_p2_0_primnorm,"ALP");
  mgr_primnorm-> Add(gr_p1_5_primnorm,"ALP");
  TCanvas * c_AbsGain_primnorm = new TCanvas("c_AbsGain_primnorm","", 800,600);
  mgr_primnorm->GetYaxis()->SetTitleOffset(0.9);
  mgr_primnorm->Draw("ALP");
  leg_primnorm->Draw(); 
  ...
  TCanvas * c_AbsGain_EL = new TCanvas("c_AbsGain_EL","", 800,600);
  TMultiGraph *mgr_EL = new TMultiGraph();
  mgr_EL->SetTitle("; EL gap E/N (Td);  EL photon number per event ");
  //mgr_EL-> GetYaxis()->SetTitleOffset(1);
  mgr_EL-> Add(gr_p1_0_EL, "ALP");
  mgr_EL-> Add(gr_p2_0b_EL, "ALP");
  //  mgr_EL-> Add(gr_p2_0_EL,"ALP");
  mgr_EL-> Add(gr_p1_5_EL,"ALP");
  mgr_EL->Draw("ALP");
   
  
  auto leg_EL = new TLegend(0.1,0.7,0.48,0.9);
  leg_EL->AddEntry(gr_p1_0, " 1 bar", "l");
  leg_EL->AddEntry(gr_p1_5, " 1.5 bar", "l");
  leg_EL->AddEntry(gr_p2_0b, " 2 bar", "l");  
  leg_EL->Draw();
  auto leg_EL_p1_0 = new TLegend(0.2,0.7,0.38,0.8);
  leg_EL_p1_0->AddEntry(gr_p1_0_EL, " 1 bar", "l");
  auto leg_EL_p2_0 = new TLegend(0.2,0.7,0.48,0.8);
  leg_EL_p2_0->AddEntry(gr_p2_0_EL, " 2 bar (ThGEM 2250 V)", "l");
  auto leg_EL_p1_5 = new TLegend(0.2,0.7,0.38,0.8);
  leg_EL_p1_5->AddEntry(gr_p1_5_EL, " 1.5 bar ", "l");
  auto leg_EL_p2_0b = new TLegend(0.2,0.7,0.48,0.8);
  leg_EL_p2_0b->AddEntry(gr_p2_0b_EL, " 2 bar (ThGEM 2150 V) ", "l");
  TCanvas * c_AbsGain_EL_sep = new TCanvas("c_AbsGain_EL_sep","", 1600,1200);
